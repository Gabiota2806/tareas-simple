                ...
                <form method="POST" action="{{ route('careers.store') }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="w-full rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-gray-700 shadow-sm font-nunito flex items-center justify-between cursor-not-allowed">
                            <span class="truncate">
                                @php
                                    $activeUni = $universities->firstWhere('id', $activeUniId);
                                @endphp
                                {{ $activeUni ? $activeUni->name : 'Universidad Desconocida' }}
                            </span>
                        ...
                        <input type="hidden" name="university_id" value="{{ $activeUniId }}">
