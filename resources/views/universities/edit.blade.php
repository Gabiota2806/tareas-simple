    ...
    <div class="py-6">
        <div class="max-w-sm mx-auto sm:max-w-md">
            <div class="bg-white shadow-md rounded-xl p-4 sm:p-6">
                ...
                <form method="POST" action="{{ route('universities.update', $university) }}" class="space-y-4">
                    @csrf
                    @method('PATCH')
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name" required value="{{ old('name', $university->name) }}"
                    ...
                    <div>
                        ...
                        <input type="text" id="acronym" name="acronym" value="{{ old('acronym', $university->acronym) }}"
                               class="w-full rounded-lg border border-gray-200 bg-white px-3 py-2 text-gray-800 shadow-sm placeholder:text-gray-400 font-nunito
                               focus:border-violet-400 focus:ring-violet-400 transition">
                    ...
                    <div class="pt-4 flex gap-3">
                        <a href="{{ route('universities.index') }}" class="w-1/3 flex items-center justify-center rounded-lg bg-gray-100 px-4 py-2 font-semibold text-gray-600 shadow-sm transition hover:bg-gray-200 hover:-translate-y-0.5 font-nunito text-sm">
                            Cancelar
                        </a>
                        <button type="submit"
