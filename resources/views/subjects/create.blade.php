                    ...
                    <div class="flex gap-4">
                        <div class="flex-1">
                            ...
                            <select id="approval_type" name="approval_type"
                                ...
                                <option value="promocional" {{ old('approval_type') == 'promocional' ? 'selected' : '' }}>Promocional</option>
                                <option value="regular" {{ old('approval_type') == 'regular' ? 'selected' : '' }}>Regular (Con Final)</option>
                                <option value="libre" {{ old('approval_type') == 'libre' ? 'selected' : '' }}>Libre</option>
                            </select>
