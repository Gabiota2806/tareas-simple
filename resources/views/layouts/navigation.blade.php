...
<aside :class="sidebarExpanded ? 'lg:w-64' : 'lg:w-20'" 
    ...
    <div class="flex h-full flex-col px-4 py-4 overflow-y-auto lg:overflow-hidden">
        ...
        <div class="flex items-center justify-between mb-6 lg:mb-8 pt-2 lg:pt-0">
            <a href="{{ route('dashboard') }}" class="flex items-center gap-3 overflow-hidden">
                <!-- Cambiado: En celular siempre visible, en PC depende de sidebarExpanded -->
                <span :class="sidebarExpanded ? 'lg:block' : 'lg:hidden'" class="block text-2xl font-bold text-violeta-moderno whitespace-nowrap">
                    UniTask
                </span>
            </a>
            
            <!-- El botón de contraer menú solo sirve en computadoras, lo ocultamos en móvil con 'hidden lg:block' -->
            <button @click="sidebarExpanded = !sidebarExpanded" class="hidden lg:block text-gray-400 hover:text-violeta-moderno transition p-1.5 rounded-lg hover:bg-violet-50 shrink-0" :title="sidebarExpanded ? 'Contraer menú' : 'Expandir menú'">
